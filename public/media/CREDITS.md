...
`hero-wide.jpg` is a centered 2000x1200 crop of the portrait `hero.jpg` master, used above 720px
via `<picture>`; the portrait frame is served to phones. `spec.jpg` is a centered 2000x1500 crop
of its portrait master.
